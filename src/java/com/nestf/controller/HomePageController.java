 ...
 * @author NameIsDuy
 */
@WebServlet(name = "HomePageController", urlPatterns = {"/homeAction"})
public class HomePageController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ProductDTO> proList = dao.getBestSellList();
            List<ProductDTO> otherProList = dao.getListProduct();
            Collections.shuffle(otherProList);
            request.setAttribute("BEST_SELL_LIST", proList);
