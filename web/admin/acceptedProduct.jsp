                    ...
                    <li class="nav-item active">
                        ...
                        <div id="collapseProducts" class="collapse show" aria-labelledby="headingProducts"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item fw-bold" href="accpetedProductPage">Active products</a>
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Active products</h1>
                            </div>
                                    ...
                                    <tbody>
                                        <c:forEach var="product" items="${sessionScope.LIST_PRODUCT}">
                                            <tr>
                                                ...
                                                <td>${product.name}</td>
                                                <td>${money.printMoney(product.price)}</td>
                                                <td>${product.quantity}</td>
                                                <td>${product.category.categoryName}</td>
                                                <td>${money.printMoney(product.discountPrice)}</td>
                                                <td>
                                                    ...
                                                    <a href="editProductAction?productID=${product.productID}&productType=accepted" class="Edit" title="Edit" data-toggle="tooltip"><i class="fas fa-edit"></i></a>
