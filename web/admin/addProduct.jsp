                                ...
                                <form action="addNewProductAction" method="Post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4 pb-2">
                                            ...
                                            <select class="form-control form-control-lg" name="sellerID">
                                                <label class="form-label select-label">Choose option:</label>
                                                <option disabled>Choose option</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 mb-4 pb-2">
                                            <div class="form-outline mb-4 block">
                                                <input type="text" id="image" name="image1" value="${productDetail.image}" class="form-control form-control-lg" placeholder="Nhập link ảnh" />
                                            </div>
                                            <div class="form-outline mb-4 block">
                                                <input type="text" id="image" name="image2" value="${productDetail.image}" class="form-control form-control-lg" placeholder="Nhập link ảnh"/>
                                            </div>
                                            <div class="form-outline mb-4 block">
                                                <input type="text" id="image" name="image3" value="${productDetail.image}" class="form-control form-control-lg" placeholder="Nhập link ảnh"/>
                                            </div>
                                            <div class="form-outline mb-4 block">
                                                <input type="text" id="image" name="image4" value="${productDetail.image}" class="form-control form-control-lg" placeholder="Nhập link ảnh"/>
                                            </div>
                                            <div class="form-outline mb-4 block">
                                                <input type="text" id="image" name="image5" value="${productDetail.image}" class="form-control form-control-lg" placeholder="Nhập link ảnh"/>
                                            </div>
                                            <div id="load">
